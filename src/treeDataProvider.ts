...
export class CopilotRulesTreeDataProvider
  implements vscode.TreeDataProvider<RuleItem>
{
  private _onDidChangeTreeData: vscode.EventEmitter<
    RuleItem | undefined | null | void
  ...
  getChildren(element?: RuleItem): Thenable<RuleItem[]> {
    if (!element) {
      return Promise.resolve([
        new RuleItem(
          "📝 Edit Custom Rules",
          "Edit your custom AI agent rules",
          vscode.TreeItemCollapsibleState.None,
          "openRulesEditor"
        ),
        new RuleItem(
          "🚀 Inject Rules Now",
          "Inject custom rules to .github/instructions/",
          vscode.TreeItemCollapsibleState.None,
          "injectRules"
        ),
        new RuleItem(
          "🔄 Reset to Default",
          "Reset rules to default AI agent rules",
          vscode.TreeItemCollapsibleState.None,
          "resetToDefault"
        ),
        new RuleItem(
